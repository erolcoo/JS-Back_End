...
userRouter.post(
  ...
  body('password').trim().isAlphanumeric().isLength({ min: 3 }).withMessage('Password must be at least 6 characters long and may contain only English letters and numbers'),
